...
public class TableNames {
	...
	// maybe we should merge all the courses metadata into a single table and add course_type to it
	//public static final String FLASH_CARD_COURSES = "FLASH_CARD_COURSES";
